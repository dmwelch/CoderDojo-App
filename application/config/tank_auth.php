...
|--------------------------------------------------------------------------
*/
$config['use_recaptcha'] = TRUE; // DO NOT CHANGE TO FALSE
$config['recaptcha_public_key'] = '6LckEccSAAAAAPhnum1-a2Y1BSH-4AeM9uQdMauN';
$config['recaptcha_private_key'] = '6LckEccSAAAAAE8yMt-qKYEVVUajdmRUYmwJDQbT';
